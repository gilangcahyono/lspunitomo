...
@section('content')
  <h1 class="text-center text-xl font-bold text-gray-900 dark:text-white sm:text-xl">
    IA 05A <br> PERTANYAAN TERTULIS PILIHAN GANDA
  </h1>
  ...
  <div class="relative overflow-x-auto">
    ...
    <h2 class="mb-2 mt-5 font-bold text-gray-500 dark:text-gray-400">Jawab semua pertanyaan berikut:
    </h2>
    <table class="mb-3 w-full text-left text-sm text-gray-500 rtl:text-right dark:text-gray-400">
      <thead>
        <tr class="border bg-white dark:border-gray-700 dark:bg-gray-800">
    ...
    <a href="{{ route('ia-05a.export', ['accessionId' => $accession->id]) }}" target="_blank"
