...
@section('content')
  ...
  <div class="relative overflow-x-auto">
                ...
                <th class="border px-6 py-4 dark:border-gray-700">
                  @foreach ($element->kuks as $kuks)
                    <input id="green-checkbox" type="checkbox" value=""
                      class="mb-2 block h-4 w-4 rounded border-gray-300 bg-gray-100 text-green-600 focus:ring-2 focus:ring-green-500 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-green-600">
                  @endforeach
                </th>
                <th class="border px-6 py-4 dark:border-gray-700">
                  @foreach ($element->kuks as $kuks)
    ...
    <a href="{{ route('ia-01.export', ['accessionId' => $accession->id]) }}" target="_blank"
