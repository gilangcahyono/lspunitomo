  ...
  <div class="relative max-h-full w-full max-w-md p-4">
    <div class="relative rounded-lg bg-white shadow dark:bg-gray-700">
      ...
      <div class="p-4 text-center md:p-5">
        ...
        <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Yakin ingin menghapus asesor ini ?</h3>
        <form class="inline" action="{{ route('assessors.destroy', ['assessor' => $assessor]) }}" method="POST">
          @method('DELETE')
          @csrf
          <button data-modal-hide="delete-confirm-modal" type="submit"
        ...
        <button data-modal-hide="delete-confirm-modal" type="button"
