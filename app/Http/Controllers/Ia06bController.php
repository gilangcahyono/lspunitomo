...
class Ia06bController extends Controller
{
    public function index()
    {
        $schemes = Scheme::all();

        return view('muk.ia.ia-06b.index', ['schemes' => $schemes]);
    }
    ...
    public function accessions(string $schemeId)
    {
        ...
        return view('muk.ia.ia-06b.accessions', [
            'scheme' => $scheme,
    ...
    public function show(string $schemeId, string $accessionId)
    {
        ...
        return view('muk.ia.ia-06b.show', [
            'scheme' => $scheme,
            'accession' => $accession,
        ]);
    }
