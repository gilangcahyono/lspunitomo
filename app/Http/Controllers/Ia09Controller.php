...
class Ia09Controller extends Controller
{
    public function index()
    {
        ...
        return view('muk.ia.ia-09.index', ['schemes' => $schemes]);
    }
    ...
    public function accessions(string $schemeId)
    {
        ...
        return view('muk.ia.ia-09.accessions', [
            'scheme' => $scheme,
    ...
    public function export(string $accessionId)
    {
        ...
        $filename = '18. FR.IA.09. Pertanyaan Wawancara';
