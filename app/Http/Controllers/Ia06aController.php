...
class Ia06aController extends Controller
{
    public function index()
    {
        $schemes = Scheme::all();

        return view('muk.ia.ia-06a.index', ['schemes' => $schemes]);
    }
    ...
    public function accessions(string $schemeId)
    {
        ...
        return view('muk.ia.ia-06a.accessions', [
            'scheme' => $scheme,
    ...
    public function show(string $schemeId, string $accessionId)
    {
        ...
        return view('muk.ia.ia-06a.show', [
            'scheme' => $scheme,
            'accession' => $accession,
        ]);
    }
