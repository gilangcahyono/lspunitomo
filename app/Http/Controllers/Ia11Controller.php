...
class Ia11Controller extends Controller
{
    public function index()
    {
        ...
        return view('muk.ia.ia-11.index', ['schemes' => $schemes]);
    }
    ...
    public function accessions(string $schemeId)
    {
        ...
        return view('muk.ia.ia-11.accessions', [
            'scheme' => $scheme,
    ...
    public function export(string $accessionId)
    {
        ...
        $filename = '20. FR.IA.11. Ceklist Reviu Produk (CRP)';
