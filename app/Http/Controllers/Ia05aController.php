...
class Ia05aController extends Controller
{
    public function index()
    {
        ...
        return view('muk.ia.ia-05a.index', ['schemes' => $schemes]);
    }
    ...
    public function accessions(string $schemeId)
    {
        ...
        return view('muk.ia.ia-05a.accessions', [
            'scheme' => $scheme,
    ...
    public function show(string $schemeId, string $accessionId)
    {
        ...
        return view('muk.ia.ia-05a.show', [
            'scheme' => $scheme,
            'accession' => $accession,
        ]);
    }
    ...
    public function export(string $accessionId)
    {
        ...
        $filename = '14. FR.IA.05.A. Pertanyaan Tertulis Pilihan Ganda';
