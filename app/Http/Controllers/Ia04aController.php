...
class Ia04aController extends Controller
{
    public function index()
    {
        $schemes = Scheme::all();

        return view('muk.ia.ia-04a.index', ['schemes' => $schemes]);
    }
    ...
    public function accessions(string $schemeId)
    {
        ...
        return view('muk.ia.ia-04a.accessions', [
            'scheme' => $scheme,
    ...
    public function show(string $schemeId, string $accessionId)
    {
        ...
        return view('muk.ia.ia-04a.show', [
            'scheme' => $scheme,
            'accession' => $accession,
        ]);
    }
    ...
    public function export(string $accessionId)
    {
        ...
        $jobGroups = JobGroup::where('scheme_id', $accession->scheme->id)->get();

        $filename = '13. FR.IA.04.A. Penjelasan Singkat Proyek';
